  ...
  const props = [
    {
      ...
      color: 'from-blurple/10 to-blurpleLight border-blurple/20',
    ...
    },
    {
      ...
      color: 'from-amber/10 to-amberLight border-amber/20',
    ...
    },
    {
      ...
      color: 'from-green/10 to-green/5 border-green/20',
    ...
    },
    {
      ...
      color: 'from-coral/10 to-coralLight border-coral/20',
